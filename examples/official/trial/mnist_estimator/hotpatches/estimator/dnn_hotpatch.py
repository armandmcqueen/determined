...
MODEL_FN_RESET_VISIBLE_DEVICE_LIST = read_envvar_bool("DET_DEBUG_MODEL_FN_RESET_VISIBLE_DEVICE_LIST")
print("HOTPATCH", "dnn.py", f"MODEL_FN_RESET_VISIBLE_DEVICE_LIST = {MODEL_FN_RESET_VISIBLE_DEVICE_LIST}")
...
class DNNClassifier(estimator.Estimator):
  ...
  def __init__(
    ...
    def _model_fn(features, labels, mode, config):
      if MODEL_FN_RESET_VISIBLE_DEVICE_LIST:
        print("HOTPATCH", "Changing model_fn to alter session_config")
