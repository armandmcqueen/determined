...
print("HOTPATCH", "run_config_hotpatch.py", f"DISPLAY_SESSION_CONFIG = {DISPLAY_SESSION_CONFIG}")
print("HOTPATCH", "run_config_hotpatch.py", f"DISPLAY_RUN_CONFIG = {DISPLAY_RUN_CONFIG}")
print("HOTPATCH", "run_config_hotpatch.py", f"OVERWRITE_TF_CONFIG_ENVVAR_NAME = {OVERWRITE_TF_CONFIG_ENVVAR_NAME}")
print("HOTPATCH", "run_config_hotpatch.py", f"VERBOSE_CUSTOM_LOGGING = {VERBOSE_CUSTOM_LOGGING}")


def hprint(s):
    if VERBOSE_CUSTOM_LOGGING:
        print("HOTPATCH", "run_config_hotpatch", "custom logs:", s)
